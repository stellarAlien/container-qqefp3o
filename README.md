...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qqefp3o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qqefp3o.containers.anotherwebservice.com/
...
```
git clone git@github.com:stellarAlien/container-qqefp3o.git
cd container-qqefp3o
```
...
```
docker attach container-qqefp3o
```
